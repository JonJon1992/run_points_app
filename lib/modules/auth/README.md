...
Este módulo implementa autenticação usando Firebase Auth seguindo os princípios de Clean Architecture.
...
```
Selecione o projeto Firebase e as plataformas desejadas. Isso irá gerar/atualizar o arquivo `lib/firebase_options.dart`.
